...
public class $Proxy11 extends Proxy implements UserService {
    ...
    static {
        try {
            ...
            m2 = Class.forName("org.example.aop.proxy.UserService").getDeclaredMethod("getUser");
            m3 = Class.forName("org.example.aop.proxy.UserService").getDeclaredMethod("isExist");
