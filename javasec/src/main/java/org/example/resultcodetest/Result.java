...
public class Result<T> implements Serializable {
    ...
    public static Result<Object> error(String message) {
        return new Result<>(ResultCode.SYSTEM_ERROR.getCode(),message,defaultData);
    }
    ...
    public static <T> Result<T> build(ResultCode resultCode,T result) {
