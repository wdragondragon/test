package org.example.javabase.email;
...
public class Email {
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）zdhbwkahkajxbcje
//    private String receiveMailAccount;


    @Builder
    public Email(String myEmailSMTPHost,
    ...
    /**
     * @param receiveMailAccount 收信人邮箱
     * @param subject            邮件主题
     * @param context            发送内容
     * @throws Exception
     */
    public void sendEmail(String receiveMailAccount,
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, receiveMailAccount, subject, context);
    ...
    public MimeMessage createMimeMessage(Session session,
        ...
        message.setFrom(new InternetAddress(myEmailAccount, personal, "UTF-8"));
